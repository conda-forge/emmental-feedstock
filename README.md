...
Once the `conda-forge` channel has been enabled, `emmental` can be installed with:

```
conda install emmental
```

It is possible to list all of the versions of `emmental` available on your platform with:
